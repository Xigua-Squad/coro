...
enum class State { Running, Completed, NotStarted };
...
public:
  struct promise_type {
    ...
    void return_void() { std::cout << "shared_task 执行完成\n"; }
  };
  ...
  auto operator co_await() const noexcept { return awaiterable{handle_}; }
